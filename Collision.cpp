		...
		if (Object1.getGlobalBounds().intersects(Object2.getGlobalBounds(), Intersection))
		{
			...
			for (int i = Intersection.left; i < Intersection.left + Intersection.width; i++)
			{
				for (int j = Intersection.top; j < Intersection.top + Intersection.height; j++)
				{
					...
					if (O1SubRect.width > 0 && O2SubRect.width > 0)
					{
					...
					{
						if (o1v.x > 0 && o1v.y > 0 && o2v.x > 0 && o2v.y > 0 &&
							o1v.x < abs(O1SubRect.width) && o1v.y < abs(O1SubRect.height) &&
							o2v.x < abs(O2SubRect.width) && o2v.y < abs(O2SubRect.height))
						{

							if (Bitmasks.GetPixel(mask1, Object1.getTexture(), -1 * (int)(o1v.x) + O1SubRect.left, (int)(o1v.y) + O1SubRect.top) > AlphaLimit &&
								Bitmasks.GetPixel(mask2, Object2.getTexture(), (int)(o2v.x) + O2SubRect.left, (int)(o2v.y) + O2SubRect.top) > AlphaLimit)
								return true;
						}
